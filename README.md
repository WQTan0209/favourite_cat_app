...
The app dynamically updates the UI without reloading the page, providing a smooth, interactive, and mobile-friendly experience.
At the end, the user sees a summary of all the cats they liked.
...
Google Fonts - Custom title font for better UX
